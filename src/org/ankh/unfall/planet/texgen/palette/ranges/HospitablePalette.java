...
public class HospitablePalette extends TerrainPalette
{
    public HospitablePalette(PlanetInformation informations)
    {
        super(informations);
    }
